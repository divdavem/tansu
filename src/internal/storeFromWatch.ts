...
export class RawStoreFromWatch<T> extends RawStoreComputedOrDerived<undefined> {
...
const interopSignals = new WeakMap<Signal<any>, RawStoreFromWatch<any>>();
const tansuWatchSignal = RawStoreWritable.prototype.watchSignal;
export const fromInteropSignal = (signal: Signal<any>): RawStore<any> => {
